...
import { streamSuperChat, getConversation } from '../api';
...
const SuperChat = () => {
    ...
    useEffect(() => {
        if (id) {
            ...
            setSelectedModels(['openai/gpt-4o', 'anthropic/claude-3-opus']);
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-lg p-4">
                    ...
                    <div className="flex justify-end mt-2">
                        <button
                            ...
                            className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                        >
                            <Send size={16} />
    ...
    return (
        <div className="max-w-5xl mx-auto flex flex-col h-[calc(100vh-2rem)]">
            ...
            {/* Input Area */}
            <div className="fixed bottom-6 left-64 right-6 mx-auto max-w-5xl bg-slate-900/90 backdrop-blur border border-slate-700 rounded-xl p-2 shadow-2xl flex items-end z-10">
                <textarea
                    value={prompt}
                    onChange={(e) => setPrompt(e.target.value)}
                    onKeyDown={handleKeyDown}
